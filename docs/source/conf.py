...
# Import version
try:
    from pathsim_vehicle import __version__
except ImportError:
    __version__ = "unknown"

# -- Project information -----------------------------------------------------

project = 'pathsim-vehicle'
...
html_theme_options = {
    "light_css_variables": {
        "color-brand-primary": "#e41a1c",
        "color-brand-content": "#e41a1c",
        "color-api-keyword": "#e41a1c",
    ...
    "source_repository": "https://github.com/pathsim/pathsim-vehicle",
    "source_branch": "main",
